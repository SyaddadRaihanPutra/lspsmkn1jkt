        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="py-1 menu-inner">
                    ...
                    <li class="menu-item">
                        <a href="{{ $setting->url_web_sekolah }}" target="_blank" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-support"></i>
                            <div data-i18n="Support">Hubungi Admin</div>
                        </a>
                    </li>
                </ul>
            </aside>
                                ...
                                <div class="modal-dialog modal-dialog-scrollable">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body" style="text-align: justify!important;">
                                            ...
                                            <img src="{{ asset('assets/img/qrcode_57389426_772e0f72fe3234b4091428b187cee34c.png') }}"
                                                width="80" alt="">
                                            <hr>
