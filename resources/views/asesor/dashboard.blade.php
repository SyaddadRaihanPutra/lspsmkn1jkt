                    ...
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-7">
                            <div class="card-body">
                                ...
                                <p class="mb-4">
                                    Ini adalah halaman dashboard asesor. Anda dapat melihat informasi terkait
                                </p>
            ...
            <div class="order-2 mb-4 col-12 col-lg-8 order-md-3 order-lg-2">
                <div class="card">
                    <div class="row row-bordered g-0">
                        <div class="col-md-12">
                            <h5 class="pb-3 m-0 card-header me-2"><span class="fs-3"><i class='bx bx-info-circle' ></i></span> Pengumuman</h5>
                            <div class="card">
                                <div class="card-body">
